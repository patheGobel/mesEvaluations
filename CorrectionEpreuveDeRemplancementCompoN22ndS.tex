...
Donc la factorisation de $\textcolor{green}{\boxed{P(x)=2(x-1)(x+2)(4x-3)}}$
...
\draw [line width=2pt] (-9,3)-- (-9,2);
\begin{scriptsize}
\draw [fill=ududff] (-6.59,3.57) circle (2.5pt);
\draw [fill=ududff] (-3.59,3.59) circle (2.5pt);
\draw [fill=ududff] (-0.63,3.61) circle (2.5pt);
\draw [fill=ududff] (2.95,3.61) circle (2.5pt);
\draw [fill=ududff] (-8.63,2.41) circle (2.5pt);
\draw [fill=ududff] (-3.61,2.51) circle (2.5pt);
\draw [fill=ududff] (-0.69,2.59) circle (2.5pt);
\draw [fill=ududff] (2.97,2.53) circle (2.5pt);
\draw [fill=ududff] (-6.71,1.57) circle (2.5pt);
\draw [fill=ududff] (-3.63,1.53) circle (2.5pt);
\draw [fill=ududff] (-0.77,1.53) circle (2.5pt);
\draw [fill=ududff] (2.99,1.49) circle (2.5pt);
\end{scriptsize}
\end{tikzpicture}
