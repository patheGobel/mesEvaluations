...
\begin{tikzpicture}[level distance=3cm,
  ...
  level 3/.style={sibling distance=1cm}]%Ecarte les branches des 3eme ramifications
  ...
  \node {}
    ...
    }% Les 2ème ramification a gauche     
    child {node {$D$}  
         child {node {$C$}
              	child {node {$C$}    
      			} 
...
Soit E l’ensemble des issues possibles donc:

$E=\left\lbrace CCC;CCD;CDC;CDC;DCC;DCC;DCC;DCC \right\rbrace $

$X=\left\lbrace 3;2;2;2;2;2;2;2  \right\rbrace $

\textbf{\textcolor{red}{Variable aléatoire}} X donnant le nombre de pièce de 500F pour chaque éventualité de E.

\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
\hline
Eventualité de E & $CCC$ & $CCD$ & $CDC$&$CDC$&$DCC$&$DCC$&$DCC$&$DCC$\\
\hline
Valeurs prises par X &$3$ &$2$&$2$&$2$&$2$&$2$&$2$&$2$ \\
\hline
\end{tabular}\\
D'où:$X(E) = \left\lbrace 3 ; 2 \right\rbrace $\\

\textbf{Probabilité sur l'univers $X(E)$ au loi de probabilité de la variable aléatoire X}

$p_{1}=P(X=3)=\frac{1}{8}$ ; $p_{2}=P(X=2)=\frac{7}{8}$

\begin{tabular}{|c|c|c|}
\hline
$x_{i}$ & $X_{1}=3$ & $X_{2}=2$\\
\hline
$p_{i} = p(X = x_{i}) $ &$\frac{1}{8}$ &$\frac{7}{8}$ \\
\hline
\end{tabular}
