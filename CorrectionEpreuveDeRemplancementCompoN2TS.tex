...
\[
p_{1}=P(X = 2) = \frac{\binom{4}{2} \times \binom{1}{1}}{\binom{5}{3}} = \frac{6 \times 1}{10} = \frac{3}{5}
\]

- Pour \(X = 3\) : tirer 3 pièces de 500 F parmi 4 et 0 pièce de 200 F parmi 1.
\[
p_{1}=P(X = 3) = \frac{\binom{4}{3} \times \binom{1}{0}}{\binom{5}{3}} = \frac{4 \times 1}{10} = \frac{2}{5}
\]
