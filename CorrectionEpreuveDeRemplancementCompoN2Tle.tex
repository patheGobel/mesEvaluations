...
$\Longrightarrow \ln(1-x) \geq \ln\left[ (2x+3)(x-1)\right]  \Longrightarrow (1-x) = (2x+3)(x-1) \Longrightarrow 1-x= 2x^{2}-2x+3x-3$

$\Longrightarrow 2x^{2}+2x-4 = 0 \Longrightarrow x=1$ ou $x=-2$.
