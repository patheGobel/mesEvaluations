...
f'(x)&=\frac{(7x-9)'(4x-5)-(4x-5)'(7x-9)}{(4x-5)^{2}}\\
	...
	&=\frac{1}{(4x-5)^{2}}\\
\end{align*}
Donc \textcolor{green}{\boxed{f'(x)=\frac{1}{(4x-5)^{2}}}}\textbf{ 0,5 pt}

\textcolor{green}{D'après l'expression de la dérivée, $\forall x\in Df, f'(x)>0 $ \text{donc f est croissante.}}
 
\end{itemize}

\item \textcolor{red}{Tableau de variation de f}
\begin{center}
...
\end{tikzpicture}
\end{center}
\item \textcolor{red}{Tracons $C_f$. \textbf{0,75 pt}}
...
f'(x)&=\frac{(1-x)'(2+3x)-(2+3x)'(1-x)}{(2+3x)^{2}}\\
	...
	&=\frac{-7}{(2+3x)^{2}}\\
\end{align*}
Donc \textcolor{green}{\boxed{f'(x)=\frac{-7}{(2+3x)^{2}}}}\textbf{ 0,5 pt}
