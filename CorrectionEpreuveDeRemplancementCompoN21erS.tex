...
Donc \textcolor{green}{\boxed{card(\Omega)=}}
...
\end{align*}
\[card(A)=\]
Donc \textcolor{green}{\boxed{card(A)=}}
...
\end{align*}
\[card(B)=\]
Donc \textcolor{green}{\boxed{card(B)=}}
...
\end{align*}
\[card(C)=\]
Donc \textcolor{green}{\boxed{card(C)=}}
...
\end{align*}
\[card(D)=\]
Donc \textcolor{green}{\boxed{card(D)=}}
\end{itemize}
\end{itemize}
