...
\subsection*{3) Etudions de continuité: (0,5pt +1pt)}
\[ f(x) = \begin{cases} 
  -x+1-\frac{2x}{x^{2}+1}, & \text{si } x \leq 1 \\
  \frac{x-1}{\sqrt{x^{2}-2x+6}}, & \text{si } x > 1
\end{cases} \]
...
\[\lim_{x \to 1^{+}}f_{2}(x)=\lim_{x \to 1^{+}}f_{2}\frac{x-1}{\sqrt{x^{2}-2x+6}}\]
\[\lim_{x \to 1^{+}}f(x)=0\]
\[\text{Non,} \lim_{x \to 1^{-}}f(x)=\lim_{x \to 1^{+}}f(x) \text{ Donc f n'est pas continuen }\]
